...
def put_text(img, text_fps, text_ear, text_es, text_blink, text_blink_avg, text_head_pose_y, color):
    cv2.putText(img, text_fps, (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
    cv2.putText(img, text_ear, (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
    cv2.putText(img, text_es, (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
    cv2.putText(img, text_blink, (10, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color, 1)
